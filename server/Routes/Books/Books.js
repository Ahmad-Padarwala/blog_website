...
var imgconfig = multer.diskStorage({
  destination: (req, file, callback) => {
    callback(null, "../client/public/upload/book");
  },
...
router.route("/getBooksWithLimits/:limit").get(Books.getBooksWithLimits);
router.route("/getAllBookCateFilter/:id").get(Books.getAllBookCateFilter);
